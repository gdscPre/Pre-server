package com.pre.pre_server.authentication.Jwt;

import com.pre.pre_server.authentication.Service.CustomerUserDetailsService;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String token){
        UserDetails userDetails = customerUserDetailsService.loadUserByUsername(this.getUserEmail(token));
